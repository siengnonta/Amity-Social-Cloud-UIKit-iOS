//
//  AmityStreamNotificationsManager.h
//  AmitySDK
//
...
*/
@interface AmityStreamNotificationsManager : NSObject
 ...
 */
- (void)setIsAllowed:(BOOL)isAllowed completion:(nullable AmityRequestCompletion)completion;
